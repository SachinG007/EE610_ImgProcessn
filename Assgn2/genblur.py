...
def deblur(blur_img, kernel,shift_fft_mat):
	...
	output = np.multiply(fft_blur_img,fft_kernel)
...
blur_img = cv2.imread("/Users/sachin007/Documents/EE610/EE610_ImgProcessn/Assgn2/original1.jpg",1) #load the blurred image
...
cv2.imwrite("genblur.png",deblur_img)
cv2.waitKey(0)